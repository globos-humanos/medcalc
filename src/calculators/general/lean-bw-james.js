const calc={id:'lean-bw-james',name:'Lean Body Weight — James',shortName:'James LBW',categoryId:'general',description:'Lean body weight using the James equation.',type:'calculation',
