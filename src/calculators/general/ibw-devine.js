const calc={id:'ibw-devine',name:'Ideal Body Weight — Devine',shortName:'IBW Devine',categoryId:'general',description:'Ideal body weight using the Devine formula.',type:'calculation',
